...
class LoadedOBJ extends Geometry {
   ...
   */
  constructor(objStr, val, yVal, redColor, greenColor, blueColor) {
    super();
   ...
   // console.log(objStr);
    ...
    this.moveOBJToCenterOfScreen(transAndScaleVal[0], val, yVal);
   ...
   * axis (indices: 0, 1, 2)
   */
  moveOBJToCenterOfScreen(transValue, val,  yVal) {
    this.modelMatrix.setTranslate(transValue[0] + val, yVal-1.3, transValue[2]-9);
  }
